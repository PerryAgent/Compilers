(* The compiler from expression to tiger *)
structure EC =
struct
...
val _           = TextIO.output(TextIO.stdOut, MP.mp executable)
val _           = TextIO.output(TextIO.stdErr, "Pretty Printing IR:\n\n" ^ IR.pp executable)
val _           = TextIO.output(TextIO.stdErr, "\n\nBasic Blocks:\n\n" ^ MIPSBasicBlocks.printBlock (MIPSBasicBlocks.basicBlocks executable))
